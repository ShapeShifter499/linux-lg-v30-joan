...
/* Skip the fwk/svc version APR commands, which the msm8998 ADSP
 * firmware mishandles (sending them wedges its QMI/glink transport).
 * Set via cmdline: q6core.skip_versions=1
 */
