...
/* Decodes nothing: used for requests whose content the AP ignores.  The
 * QMI decoder skips TLVs it has no element for.
 */
const struct qmi_elem_info ipa_empty_req_ei[] = {
	{
		.data_type	= QMI_EOTI,
	},
};
